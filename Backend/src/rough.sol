...
contract PropertyPremiumCalculator {
    ...
    function updateLocationRiskMultiplier(
    ...
    function updateTypeRiskMultiplier(
    ...
    function updateProtectionDiscount(
    ...
    function calculateProtectionDiscount(
    ...
    function calculateInsurancePremium(
        ...
        int256 ageAdjustment = age > 30
            ? ageAdjustments[40]
            : ageAdjustments[(age / 10) * 10]; // Bracketed age adjustment

        // Calculate premium
        int256 premium = int256(baseRate) *
            (int256(locationRisk) +
                int256(typeRisk) +
                protectionDiscount +
                ageAdjustment);
